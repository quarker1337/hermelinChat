...
CREATE_ARTIFACT_SCHEMA = {
    ...
    "description": (
        ...
        "For themed HTML/iframe artifacts, use the CSS variable pattern from "
        "examples/artifacts/iframe_theme_skeleton.html -- it auto-syncs with the "
        "active hermelinChat theme via postMessage so colors stay consistent.\n\n"
